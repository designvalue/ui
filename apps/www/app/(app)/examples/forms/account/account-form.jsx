...
export function AccountForm() {
    ...
    return (<Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <FormField control={form.control} name="dob" render={function (_a) {
            var field = _a.field;
            return (<FormItem className="flex flex-col">
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar mode="single" selected={field.value} onSelect={field.onChange} disabled={function (date) {
        ...
        <FormField control={form.control} name="language" render={function (_a) {
            var _b;
            var field = _a.field;
            return (<FormItem className="flex flex-col">
                ...
                <PopoverTrigger asChild>
                  <FormControl>
                    <Button variant="outline" role="combobox" className={cn("w-[200px] justify-between", !field.value && "text-muted-foreground")}>
                      {field.value
                    ? (_b = languages.find(function (language) { return language.value === field.value; })) === null || _b === void 0 ? void 0 : _b.label
                    : "Select language"}
                ...
                <PopoverContent className="w-[200px] p-0">
                  <Command>
                    ...
                    <CommandList>
                      ...
                      <CommandGroup>
                        {languages.map(function (language) { return (<CommandItem value={language.label} key={language.value} onSelect={function () {
                        form.setValue("language", language.value);
                    }}>
                            <Check className={cn("mr-2", language.value === field.value
                        ? "opacity-100"
                        : "opacity-0")}/>
                            {language.label}
                          </CommandItem>); })}
