      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-4">
            <FormField control={form.control} name="communication_emails" render={function (_a) {
            var field = _a.field;
            ...
            <FormField control={form.control} name="marketing_emails" render={function (_a) {
            var field = _a.field;
            return (<FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    <FormLabel className="text-base">
            ...
            <FormField control={form.control} name="social_emails" render={function (_a) {
            var field = _a.field;
            return (<FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
            ...
            <FormField control={form.control} name="security_emails" render={function (_a) {
            var field = _a.field;
            return (<FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
        ...
        <FormField control={form.control} name="mobile" render={function (_a) {
            var field = _a.field;
