...
export function ProfileForm() {
    ...
    }), fields = _a.fields, append = _a.append;
    ...
    return (<Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <FormField control={form.control} name="bio" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
        ...
        <div>
          {fields.map(function (field, index) { return (<FormField control={form.control} key={field.id} name={"urls.".concat(index, ".value")} render={function (_a) {
                var field = _a.field;
                return (<FormItem>
          ...
          <Button type="button" variant="outline" size="sm" className="mt-2" onClick={function () { return append({ value: "" }); }}>
            Add URL
          </Button>
        </div>
