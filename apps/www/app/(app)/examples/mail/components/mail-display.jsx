...
export function MailDisplay(_a) {
    var mail = _a.mail;
    var today = new Date();
    return (<div className="flex h-full flex-col">
      ...
      <Separator />
      {mail ? (<div className="flex flex-1 flex-col">
          <div className="flex items-start p-4">
            ...
            {mail.date && (<div className="ml-auto text-xs text-muted-foreground">
          ...
          <div className="p-4">
            <form>
              <div className="grid gap-4">
                <Textarea className="p-4" placeholder={"Reply ".concat(mail.name, "...")}/>
                <div className="flex items-center">
                  <Label htmlFor="mute" className="flex items-center gap-2 text-xs font-normal">
                    <Switch id="mute" aria-label="Mute thread"/> Mute this
                    thread
                  </Label>
                  <Button onClick={function (e) { return e.preventDefault(); }} size="sm" className="ml-auto">
                    Send
                  </Button>
                </div>
              </div>
