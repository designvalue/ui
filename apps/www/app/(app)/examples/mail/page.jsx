...
export default function MailPage() {
    var layout = cookies().get("react-resizable-panels:layout:mail");
    var collapsed = cookies().get("react-resizable-panels:collapsed");
    var defaultLayout = layout ? JSON.parse(layout.value) : undefined;
    var defaultCollapsed = collapsed ? JSON.parse(collapsed.value) : undefined;
    return (<>
