...
export var columns = [
    ...
    {
        accessorKey: "amount",
        header: function () { return <div className="text-right">Amount</div>; },
        cell: function (_a) {
            var row = _a.row;
    ...
    },
    {
        ...
        cell: function (_a) {
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem onClick={function () { return navigator.clipboard.writeText(payment.id); }}>
              Copy payment ID
            </DropdownMenuItem>
    ...
    return (<Card>
      ...
      <CardContent>
        <div className="mb-4 flex items-center gap-4">
          <Input placeholder="Filter emails..." value={(_b = (_a = table.getColumn("email")) === null || _a === void 0 ? void 0 : _a.getFilterValue()) !== null && _b !== void 0 ? _b : ""} onChange={function (event) { var _a; return (_a = table.getColumn("email")) === null || _a === void 0 ? void 0 : _a.setFilterValue(event.target.value); }} className="max-w-sm"/>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
          ...
          <Table>
            <TableHeader>
              {table.getHeaderGroups().map(function (headerGroup) { return (<TableRow key={headerGroup.id}>
                ...
                return (<TableHead key={header.id} className="[&:has([role=checkbox])]:pl-3">
            ...
            <TableBody>
              {((_c = table.getRowModel().rows) === null || _c === void 0 ? void 0 : _c.length) ? (table.getRowModel().rows.map(function (row) { return (<TableRow key={row.id} data-state={row.getIsSelected() && "selected"}>
                    {row.getVisibleCells().map(function (cell) { return (<TableCell key={cell.id} className="[&:has([role=checkbox])]:pl-3">
