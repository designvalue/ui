          ...
          <Command>
            ...
            <CommandList>
              ...
              <CommandGroup>
                ...
                setSelectedStatus(statuses.find((priority) => priority.value === value) ||
                    null);
                setOpen(false);
            }}>
                    <status.icon className={cn("mr-2 h-4 w-4", status.value === (selectedStatus === null || selectedStatus === void 0 ? void 0 : selectedStatus.value)
                ? "opacity-100"
                : "opacity-40")}/>
