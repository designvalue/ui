...
import { NavigationMenu, NavigationMenuContent, NavigationMenuItem, NavigationMenuLink, NavigationMenuList, NavigationMenuTrigger, navigationMenuTriggerStyle, } from "@/registry/default/ui/navigation-menu";
import { Separator } from "@/registry/default/ui/separator";
import { Sidebar, SidebarContent, SidebarFooter, SidebarGroup, SidebarGroupContent, SidebarGroupLabel, SidebarHeader, SidebarInset, SidebarMenu, SidebarMenuAction, SidebarMenuButton, SidebarMenuItem, SidebarMenuSub, SidebarMenuSubButton, SidebarMenuSubItem, SidebarProvider, SidebarTrigger, useSidebar, } from "@/registry/default/ui/sidebar";
export var iframeHeight = "800px";
export var description = "An inset sidebar with site header navigation.";
    ...
    return (<div style={{
      ...
      <header className="sticky top-0 bg-sidebar flex h-[--header-height] shrink-0 items-center gap-2 border-b px-4 isolate z-20">
        <div className="flex items-center gap-2 w-full">
          <Button className="hidden md:flex" variant="ghost" size="icon" onClick={function () { return setOpen(!open); }}>
            <Sidebar />
          </Button>
                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
                      {components.map(function (component) { return (<li>
        ...
        <Sidebar className="top-[--header-height] pb-[--header-height]" variant="inset">
          ...
          <SidebarContent>
            <SidebarGroup>
              ...
              <SidebarMenu>
                {data.navMain.map(function (item) {
            var _a, _b;
            return (<Collapsible key={item.title} asChild defaultOpen={item.isActive}>
                    <SidebarMenuItem>
                      ...
                      {((_a = item.items) === null || _a === void 0 ? void 0 : _a.length) ? (<>
                          ...
                          <CollapsibleContent>
                            <SidebarMenuSub>
                              {(_b = item.items) === null || _b === void 0 ? void 0 : _b.map(function (subItem) { return (<SidebarMenuSubItem key={subItem.title}>
            ...
            <SidebarGroup className="group-data-[collapsible=icon]:hidden">
              ...
              <SidebarMenu>
                {data.projects.map(function (item) { return (<SidebarMenuItem key={item.name}>
            ...
            <SidebarGroup className="mt-auto">
              <SidebarGroupContent>
                <SidebarMenu>
                  {data.navSecondary.map(function (item) { return (<SidebarMenuItem key={item.title}>
