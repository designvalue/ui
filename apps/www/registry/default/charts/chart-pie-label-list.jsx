        ...
        <ChartContainer config={chartConfig} className="mx-auto aspect-square max-h-[250px] [&_.recharts-text]:fill-background">
          <PieChart>
            ...
            <Pie data={chartData} dataKey="visitors">
              <LabelList dataKey="browser" className="fill-background" stroke="none" fontSize={12} formatter={(value) => { var _a; return (_a = chartConfig[value]) === null || _a === void 0 ? void 0 : _a.label; }}/>
            </Pie>
          </PieChart>
        </ChartContainer>
      </CardContent>
