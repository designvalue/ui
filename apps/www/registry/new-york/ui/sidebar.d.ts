...
import { TooltipContent } from "@/registry/new-york/ui/tooltip";
...
declare const SidebarTrigger: React.ForwardRefExoticComponent<Omit<import("@/registry/new-york/ui/button").ButtonProps & React.RefAttributes<HTMLButtonElement>, "ref"> & React.RefAttributes<HTMLButtonElement>>;
