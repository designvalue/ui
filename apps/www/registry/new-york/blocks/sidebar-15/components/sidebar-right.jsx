...
import { Sidebar, SidebarContent, SidebarFooter, SidebarHeader, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarSeparator, } from "@/registry/new-york/ui/sidebar";
// This is sample data.
const data = {
    user: {
        name: "shadcn",
