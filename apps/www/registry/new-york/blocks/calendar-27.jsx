...
export default function Calendar27() {
    ...
    return (<Card className="@container/card w-full max-w-xl">
      <CardHeader className="@md/card:grid relative flex flex-col border-b">
        ...
        <Popover>
          ...
          <PopoverContent className="w-auto overflow-hidden p-0" align="end">
            <Calendar className="w-full" mode="range" defaultMonth={range === null || range === void 0 ? void 0 : range.from} selected={range} onSelect={setRange} disableNavigation startMonth={range === null || range === void 0 ? void 0 : range.from} fixedWeeks showOutsideDays disabled={{
      ...
      <CardContent className="px-4">
        <ChartContainer config={chartConfig} className="aspect-auto h-[250px] w-full">
          <BarChart accessibilityLayer data={filteredData} margin={{
            left: 12,
            right: 12,
        }}>
            ...
            <ChartTooltip content={<ChartTooltipContent className="w-[150px]" nameKey="visitors" labelFormatter={(value) => {
