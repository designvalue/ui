...
export var description = "A collection of health charts.";
export var iframeHeight = "900px";
export var containerClassName = "min-h-screen py-12";
export default function Charts() {
    return (<div className="chart-wrapper mx-auto flex max-w-6xl flex-col flex-wrap items-start justify-center gap-6 p-6 sm:flex-row sm:p-8">
      <div className="grid w-full gap-6 sm:grid-cols-2 lg:max-w-[22rem] lg:grid-cols-1 xl:max-w-[25rem]">
        <Card x-chunk="A bar chart showing the number of steps you have walked in the past 7 days." className="lg:max-w-md">
          ...
          <CardContent>
            ...
            steps: {
              ...
              <BarChart accessibilityLayer margin={{
            left: -4,
            right: -4,
        }} data={[
            {
            ...
            },
            {
                ...
                <XAxis dataKey="date" tickLine={false} axisLine={false} tickMargin={4} tickFormatter={function (value) {
            return new Date(value).toLocaleDateString("en-US", {
                weekday: "short",
            });
        }}/>
                <ChartTooltip defaultIndex={2} content={<ChartTooltipContent hideIndicator labelFormatter={function (value) {
                return new Date(value).toLocaleDateString("en-US", {
                    day: "numeric",
                    month: "long",
                    year: "numeric",
        ...
        <Card x-chunk="A line chart showing the resting heart rate for the past 7 days." className="flex flex-col lg:max-w-md">
          ...
          <CardContent className="flex flex-1 items-center">
            ...
            resting: {
              ...
              <LineChart accessibilityLayer margin={{
            left: 14,
            right: 14,
            top: 10,
        }} data={[
            ...
            },
            {
                ...
                <XAxis dataKey="date" tickLine={false} axisLine={false} tickMargin={8} tickFormatter={function (value) {
            return new Date(value).toLocaleDateString("en-US", {
                weekday: "short",
            });
        }}/>
                <Line dataKey="resting" type="natural" fill="var(--color-resting)" stroke="var(--color-resting)" strokeWidth={2} dot={false} activeDot={{
            fill: "var(--color-resting)",
            stroke: "var(--color-resting)",
            r: 4,
        }}/>
                <ChartTooltip content={<ChartTooltipContent indicator="line" labelFormatter={function (value) {
                return new Date(value).toLocaleDateString("en-US", {
                    day: "numeric",
                    month: "long",
                    year: "numeric",
      ...
      <div className="grid w-full flex-1 gap-6 lg:max-w-[20rem]">
        <Card x-chunk="Two horizontal bar charts showing total steps taken during the current year and last year." className="max-w-xs">
          <CardHeader>
          ...
          <CardContent className="grid gap-4">
            ...
            steps: {
                ...
                <BarChart accessibilityLayer layout="vertical" margin={{
            left: 0,
            top: 0,
            right: 0,
            bottom: 0,
        ...
        <Card x-chunk="A bar chart showing the walking and running distance for the past 7 days." className="max-w-xs">
        ...
        ]} layout="vertical" barSize={32} barGap={2}>
      ...
      <div className="grid w-full flex-1 gap-6">
        <Card x-chunk="A radial bar chart showing the percentage of time spent moving, exercising, and standing." className="max-w-xs">
        ...
        ]} innerRadius="20%" barSize={24} startAngle={90} endAngle={450}>
        ...
        <Card x-chunk="An area chart showing the time spent in bed for the past 7 days." className="max-w-xs">
          ...
          <CardContent className="p-0">
            ...
            bottom: 0,
                ...
                <ChartTooltip cursor={false} content={<ChartTooltipContent hideLabel/>} formatter={function (value) { return (<div className="flex min-w-[120px] items-center text-xs text-muted-foreground">
                      Time in bed
