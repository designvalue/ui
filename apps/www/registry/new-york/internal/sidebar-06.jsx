...
import { Sidebar, SidebarContent, SidebarFooter, SidebarGroup, SidebarHeader, SidebarInput, SidebarInset, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarProvider, SidebarRail, SidebarTrigger, } from "@/registry/new-york/ui/sidebar";
      ...
      <Sidebar>
        ...
        <SidebarContent>
          <SidebarGroup>
            ...
            var _a;
            return (<DropdownMenu key={item.title}>
                  <SidebarMenuItem>
                    ...
                    {((_a = item.items) === null || _a === void 0 ? void 0 : _a.length) ? (<DropdownMenuContent side="bottom" align="end" className="min-w-56 rounded-lg">
                        {item.items.map((item) => (<DropdownMenuItem asChild key={item.title}>
