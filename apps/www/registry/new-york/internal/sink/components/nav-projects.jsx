...
import { SidebarGroup, SidebarGroupLabel, SidebarMenu, SidebarMenuAction, SidebarMenuButton, SidebarMenuItem, useSidebar, } from "@/registry/new-york/ui/sidebar";
export function NavProjects(_a) {
    ...
    return (<SidebarGroup className="group-data-[collapsible=icon]:hidden">
      ...
      <SidebarMenu>
        {projects.map(function (item) { return (<SidebarMenuItem key={item.name}>
