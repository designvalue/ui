...
import { Sidebar, SidebarContent, SidebarGroup, SidebarGroupContent, SidebarHeader, SidebarInput, SidebarInset, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarMenuSub, SidebarMenuSubButton, SidebarMenuSubItem, SidebarProvider, SidebarRail, SidebarTrigger, } from "@/registry/new-york/ui/sidebar";
      ...
      <Sidebar>
        ...
        <SidebarContent>
          <SidebarGroup>
            ...
            var _a;
            return (<Collapsible key={item.title} defaultOpen={index === 1} className="group/collapsible">
                  <SidebarMenuItem>
                    ...
                    {((_a = item.items) === null || _a === void 0 ? void 0 : _a.length) ? (<CollapsibleContent>
                        <SidebarMenuSub>
