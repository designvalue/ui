...
import { ArchiveX, BadgeCheck, Bell, ChevronsUpDown, Command, CreditCard, File, Inbox, LogOut, Send, Sparkles, Trash2, } from "lucide-react";
...
import { DropdownMenu, DropdownMenuContent, DropdownMenuGroup, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger, } from "@/registry/new-york/ui/dropdown-menu";
import { Label } from "@/registry/new-york/ui/label";
import { Separator } from "@/registry/new-york/ui/separator";
import { Sidebar, SidebarContent, SidebarFooter, SidebarGroup, SidebarGroupContent, SidebarHeader, SidebarInput, SidebarInset, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarProvider, SidebarTrigger, useSidebar, } from "@/registry/new-york/ui/sidebar";
    ...
    return (<SidebarProvider style={{
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4">
          {Array.from({ length: 24 }).map((_, index) => (<div key={index} className="aspect-video h-12 w-full rounded-lg bg-muted/50"/>))}
        </div>
      </SidebarInset>
    </SidebarProvider>);
}
          ...
          <SidebarGroup>
            <SidebarGroupContent className="px-1.5 md:px-0">
              <SidebarMenu>
                ...
                setOpen(true);
            }} isActive={(activeItem === null || activeItem === void 0 ? void 0 : activeItem.title) === item.title} className="px-2.5 md:px-2">
                      <item.icon />
      ...
      <Sidebar collapsible="none" className="hidden flex-1 md:flex">
        <SidebarHeader className="gap-3.5 border-b p-4">
          <div className="flex w-full items-center justify-between">
            <div className="text-base font-medium text-foreground">
              {activeItem === null || activeItem === void 0 ? void 0 : activeItem.title}
            </div>
        ...
        <SidebarContent>
          <SidebarGroup className="px-0">
            <SidebarGroupContent>
              {mails.map((mail) => (<a href="#" key={mail.email} className="flex flex-col items-start gap-2 whitespace-nowrap border-b p-4 text-sm leading-tight last:border-b-0 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground">
