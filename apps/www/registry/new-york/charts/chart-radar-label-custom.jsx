      ...
      <CardContent className="pb-0">
        <ChartContainer config={chartConfig} className="mx-auto aspect-square max-h-[250px]">
          <RadarChart data={chartData} margin={{
            ...
            <PolarAngleAxis dataKey="month" tick={(_a) => {
            var { x, y, textAnchor, value, index } = _a, props = __rest(_a, ["x", "y", "textAnchor", "value", "index"]);
            const data = chartData[index];
            return (<text x={x} y={index === 0 ? y - 10 : y} textAnchor={textAnchor} fontSize={13} fontWeight={500} {...props}>
